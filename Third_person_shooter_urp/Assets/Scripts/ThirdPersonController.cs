...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        {
            baseCamera.Priority = _input.isAiming ? InactivePriority : ActivePriority;
            aimCamera.Priority = _input.isAiming ? ActivePriority : InactivePriority;
        }
        ...
        private void AimCameraUpMove()
        {
            ...
            // Cinemachine will follow this target
            CinemachineAimCameraTarget.transform.rotation = Quaternion.Euler(
